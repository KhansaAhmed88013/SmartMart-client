...
import "./CategoryView.css"; // ✅ reuse supplier styles
...
function CategoryView() {
  ...
  if (error) return <p className="supplier-message error">{error}</p>; // ✅ reused class
  ...
  const handleInputChange = (key, value) => {
    setSelectedCategory({ ...selectedCategory, [key]: value });
  };
...
{selectedCategory && (
  <div className="modal-overlay" onClick={() => setSelectedCategory(null)}>
    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
      <h3>Edit Category</h3>
      <form
        className="supplier-form"   // ✅ reuse same form styling
        onSubmit={(e) => {
          e.preventDefault();
          handleSave();
        }}
